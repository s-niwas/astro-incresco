/* clarity-js v0.7.2: https://github.com/microsoft/clarity (License: MIT) */
!(function () {
  "use strict";
  var t = Object.freeze({
      __proto__: null,
  ...
  function ln() {
    return ct(this, void 0, void 0, function () {
      var t, e, n, a, r, i, o, u, c, s;
      return st(this, function (d) {
        switch (d.label) {
          case 0:
            jt((t = { id: wr(), cost: 3 })), (d.label = 1);
          case 1:
          ...
          case 4:
            ...
            switch (
              ((u = i.target),
              (c = (function (t, e, n) {
                var a = t.target ? Bn(t.target.parentNode) : null;
                if (a && "HTML" !== a.data.tag) {
                  ...
                  cn[u] = u in cn ? cn[u] : [0, n];
                  var c = cn[u];
                  if (
                    (!1 === r && c[0] >= 10 && fn(c[2], 2, e),
              ...
              c && u && u.ownerDocument && zn(u.ownerDocument),
              c &&
                u &&
              ...
              case "characterData":
                ...
                break;
              case "childList":
                fn(i.addedNodes, 1, t), fn(i.removedNodes, 2, t);
                break;
              case "suspend":
                (s = Bn(u)) && (s.metadata.suspend = !0);
            }
            d.label = 5;
          case 5:
            return a++, [3, 2];
  ...
  function vi() {
    $r() &&
      ...
      void 0 !== mi &&
        (mi[bi] = function () {
          (mi[bi].q = mi[bi].q || []).push(arguments);
        }));
  }
